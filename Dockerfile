...
RUN R -e "remotes::install_github('VEuPathDB/veupathUtils', 'v2.6.4', upgrade_dependencies=F)"
RUN R -e "remotes::install_github('VEuPathDB/plot.data', 'v5.4.0', upgrade_dependencies=F)"
RUN R -e "remotes::install_github('microbiomeDB/microbiomeComputations', 'v5.1.1', upgrade_dependencies=F)"
