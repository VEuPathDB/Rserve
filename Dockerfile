...
RUN R -e "remotes::install_github('VEuPathDB/veupathUtils', 'v2.1.0')"
RUN R -e "remotes::install_github('VEuPathDB/plot.data','v4.1.2')"
RUN R -e "remotes::install_github('VEuPathDB/microbiomeComputations', 'v2.0.1')"
