...
RUN R -e "remotes::install_github('VEuPathDB/veupathUtils', 'v2.6.1', upgrade_dependencies=F)"
RUN R -e "remotes::install_github('VEuPathDB/plot.data', 'v5.3.1', upgrade_dependencies=F)"
RUN R -e "remotes::install_github('microbiomeDB/microbiomeComputations', 'v5.1.0', upgrade_dependencies=F)"
